...
public class ZipCodeHomeWorkTest {
    ...
    public void zipcodeJsonToMapTest(){
        ...
        //DESERIALIZATION Json  => Map using Jackson/Gson parser
       ...
       // jsonMap.put("post code", "22031");
        ...
        System.out.println("plase info = " + jsonMap.get("places"));

        List<Map<String , Object>> placeMapList = (List<Map<String , Object>>) jsonMap.get("places");
        System.out.println("placeMapList = " + placeMapList.get(0)); //print map object

        //print placeName
        System.out.println("place name = " + placeMapList.get(0).get("place name"));

        //assign the map inside the list into A SEPARETE MAP
        Map<String , Object> plaseMap = placeMapList.get(0);
        System.out.println("place name = " + plaseMap.get("place name"));
        System.out.println("longitude = " + plaseMap.get("longitude"));
        System.out.println("state = " + plaseMap.get("state"));
        System.out.println("state abbreviation = " + plaseMap.get("state abbreviation"));
        System.out.println("latitude = " + plaseMap.get("latitude"));

        assertEquals("Fairfax", plaseMap.get("place name"));
        assertEquals("-77.2649", plaseMap.get("longitude"));
        assertEquals("Virginia", plaseMap.get("state"));
        assertEquals("VA", plaseMap.get("state abbreviation"));
        assertEquals("38.8604", plaseMap.get("latitude"));
